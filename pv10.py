    ...
    def do_POST(self):
        ...
        if str(self.path) == "/webhook/waterflow_12_w0lf/LINKUSDT":
            ...
            if "COTIUSDT LONG" in dt and status_trade_COTIUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("COTIUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "COTIUSDT SHORT" in dt and status_trade_COTIUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_COTIUSDT = bar
                open_trade("COTIUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_COTIUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("COTIUSDT end of long trade" in dt) and (status_trade_COTIUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_COTIUSDT:
                    close_trade("COTIUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_COTIUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LINKUSDT LONG" in dt and status_trade_LINKUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LINKUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LINKUSDT SHORT" in dt and status_trade_LINKUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LINKUSDT = bar
                open_trade("LINKUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LINKUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LINKUSDT end of long trade" in dt) and (status_trade_LINKUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LINKUSDT:
                    close_trade("LINKUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LINKUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "QTUMUSDT LONG" in dt and status_trade_QTUMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("QTUMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "QTUMUSDT SHORT" in dt and status_trade_QTUMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_QTUMUSDT = bar
                open_trade("QTUMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_QTUMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("QTUMUSDT end of long trade" in dt) and (status_trade_QTUMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_QTUMUSDT:
                    close_trade("QTUMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_QTUMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "XLMUSDT LONG" in dt and status_trade_XLMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("XLMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "XLMUSDT SHORT" in dt and status_trade_XLMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_XLMUSDT = bar
                open_trade("XLMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_XLMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("XLMUSDT end of long trade" in dt) and (status_trade_XLMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_XLMUSDT:
                    close_trade("XLMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_XLMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LTCUSDT LONG" in dt and status_trade_LTCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LTCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LTCUSDT SHORT" in dt and status_trade_LTCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LTCUSDT = bar
                open_trade("LTCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LTCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LTCUSDT end of long trade" in dt) and (status_trade_LTCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LTCUSDT:
                    close_trade("LTCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LTCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LRCUSDT LONG" in dt and status_trade_LRCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LRCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LRCUSDT SHORT" in dt and status_trade_LRCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LRCUSDT = bar
                open_trade("LRCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LRCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LRCUSDT end of long trade" in dt) and (status_trade_LRCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LRCUSDT:
                    close_trade("LRCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LRCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "MATICUSDT LONG" in dt and status_trade_MATICUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("MATICUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "MATICUSDT SHORT" in dt and status_trade_MATICUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_MATICUSDT = bar
                open_trade("MATICUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_MATICUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("MATICUSDT end of long trade" in dt) and (status_trade_MATICUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_MATICUSDT:
                    close_trade("MATICUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_MATICUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "XTZUSDT LONG" in dt and status_trade_XTZUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("XTZUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "XTZUSDT SHORT" in dt and status_trade_XTZUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_XTZUSDT = bar
                open_trade("XTZUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_XTZUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("XTZUSDT end of long trade" in dt) and (status_trade_XTZUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_XTZUSDT:
                    close_trade("XTZUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_XTZUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DYDXUSDT LONG" in dt and status_trade_DYDXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DYDXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DYDXUSDT SHORT" in dt and status_trade_DYDXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DYDXUSDT = bar
                open_trade("DYDXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DYDXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DYDXUSDT end of long trade" in dt) and (status_trade_DYDXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DYDXUSDT:
                    close_trade("DYDXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DYDXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SOLUSDT LONG" in dt and status_trade_SOLUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SOLUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SOLUSDT SHORT" in dt and status_trade_SOLUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SOLUSDT = bar
                open_trade("SOLUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SOLUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SOLUSDT end of long trade" in dt) and (status_trade_SOLUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SOLUSDT:
                    close_trade("SOLUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SOLUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DOTUSDT LONG" in dt and status_trade_DOTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DOTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DOTUSDT SHORT" in dt and status_trade_DOTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DOTUSDT = bar
                open_trade("DOTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DOTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DOTUSDT end of long trade" in dt) and (status_trade_DOTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DOTUSDT:
                    close_trade("DOTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DOTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ADAUSDT LONG" in dt and status_trade_ADAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ADAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ADAUSDT SHORT" in dt and status_trade_ADAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ADAUSDT = bar
                open_trade("ADAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ADAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ADAUSDT end of long trade" in dt) and (status_trade_ADAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ADAUSDT:
                    close_trade("ADAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ADAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "XRPUSDT LONG" in dt and status_trade_XRPUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("XRPUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "XRPUSDT SHORT" in dt and status_trade_XRPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_XRPUSDT = bar
                open_trade("XRPUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_XRPUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("XRPUSDT end of long trade" in dt) and (status_trade_XRPUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_XRPUSDT:
                    close_trade("XRPUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_XRPUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "FILUSDT LONG" in dt and status_trade_FILUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("FILUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "FILUSDT SHORT" in dt and status_trade_FILUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_FILUSDT = bar
                open_trade("FILUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_FILUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("FILUSDT end of long trade" in dt) and (status_trade_FILUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_FILUSDT:
                    close_trade("FILUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_FILUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "FTMUSDT LONG" in dt and status_trade_FTMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("FTMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "FTMUSDT SHORT" in dt and status_trade_FTMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_FTMUSDT = bar
                open_trade("FTMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_FTMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("FTMUSDT end of long trade" in dt) and (status_trade_FTMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_FTMUSDT:
                    close_trade("FTMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_FTMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "TRXUSDT LONG" in dt and status_trade_TRXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("TRXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "TRXUSDT SHORT" in dt and status_trade_TRXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_TRXUSDT = bar
                open_trade("TRXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_TRXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("TRXUSDT end of long trade" in dt) and (status_trade_TRXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_TRXUSDT:
                    close_trade("TRXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_TRXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ALICEUSDT LONG" in dt and status_trade_ALICEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ALICEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ALICEUSDT SHORT" in dt and status_trade_ALICEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ALICEUSDT = bar
                open_trade("ALICEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ALICEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ALICEUSDT end of long trade" in dt) and (status_trade_ALICEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ALICEUSDT:
                    close_trade("ALICEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ALICEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "C98USDT LONG" in dt and status_trade_C98USDT == 0 and curr_num < max_trade:
                ...
                open_trade("C98USDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "C98USDT SHORT" in dt and status_trade_C98USDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_C98USDT = bar
                open_trade("C98USDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_C98USDT = -1
                curr_num = curr_num + 1
            ...
            if ("C98USDT end of long trade" in dt) and (status_trade_C98USDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_C98USDT:
                    close_trade("C98USDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_C98USDT = 0
                    curr_num = curr_num - 1
            ...
            if "AAVEUSDT LONG" in dt and status_trade_AAVEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("AAVEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "AAVEUSDT SHORT" in dt and status_trade_AAVEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_AAVEUSDT = bar
                open_trade("AAVEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_AAVEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("AAVEUSDT end of long trade" in dt) and (status_trade_AAVEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_AAVEUSDT:
                    close_trade("AAVEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_AAVEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "THETAUSDT LONG" in dt and status_trade_THETAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("THETAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "THETAUSDT SHORT" in dt and status_trade_THETAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_THETAUSDT = bar
                open_trade("THETAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_THETAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("THETAUSDT end of long trade" in dt) and (status_trade_THETAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_THETAUSDT:
                    close_trade("THETAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_THETAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DASHUSDT LONG" in dt and status_trade_DASHUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DASHUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DASHUSDT SHORT" in dt and status_trade_DASHUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DASHUSDT = bar
                open_trade("DASHUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DASHUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DASHUSDT end of long trade" in dt) and (status_trade_DASHUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DASHUSDT:
                    close_trade("DASHUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DASHUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BTSUSDT LONG" in dt and status_trade_BTSUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BTSUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BTSUSDT SHORT" in dt and status_trade_BTSUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BTSUSDT = bar
                open_trade("BTSUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BTSUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BTSUSDT end of long trade" in dt) and (status_trade_BTSUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BTSUSDT:
                    close_trade("BTSUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BTSUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "AVAXUSDT LONG" in dt and status_trade_AVAXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("AVAXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "AVAXUSDT SHORT" in dt and status_trade_AVAXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_AVAXUSDT = bar
                open_trade("AVAXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_AVAXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("AVAXUSDT end of long trade" in dt) and (status_trade_AVAXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_AVAXUSDT:
                    close_trade("AVAXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_AVAXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BNBUSDT LONG" in dt and status_trade_BNBUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BNBUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BNBUSDT SHORT" in dt and status_trade_BNBUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BNBUSDT = bar
                open_trade("BNBUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BNBUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BNBUSDT end of long trade" in dt) and (status_trade_BNBUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BNBUSDT:
                    close_trade("BNBUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BNBUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "COMPUSDT LONG" in dt and status_trade_COMPUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("COMPUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "COMPUSDT SHORT" in dt and status_trade_COMPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_COMPUSDT = bar
                open_trade("COMPUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_COMPUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("COMPUSDT end of long trade" in dt) and (status_trade_COMPUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_COMPUSDT:
                    close_trade("COMPUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_COMPUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BLZUSDT LONG" in dt and status_trade_BLZUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BLZUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BLZUSDT SHORT" in dt and status_trade_BLZUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BLZUSDT = bar
                open_trade("BLZUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BLZUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BLZUSDT end of long trade" in dt) and (status_trade_BLZUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BLZUSDT:
                    close_trade("BLZUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BLZUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SNXUSDT LONG" in dt and status_trade_SNXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SNXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SNXUSDT SHORT" in dt and status_trade_SNXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SNXUSDT = bar
                open_trade("SNXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SNXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SNXUSDT end of long trade" in dt) and (status_trade_SNXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SNXUSDT:
                    close_trade("SNXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SNXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "KAVAUSDT LONG" in dt and status_trade_KAVAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("KAVAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "KAVAUSDT SHORT" in dt and status_trade_KAVAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_KAVAUSDT = bar
                open_trade("KAVAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_KAVAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("KAVAUSDT end of long trade" in dt) and (status_trade_KAVAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_KAVAUSDT:
                    close_trade("KAVAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_KAVAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "TOMOUSDT LONG" in dt and status_trade_TOMOUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("TOMOUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "TOMOUSDT SHORT" in dt and status_trade_TOMOUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_TOMOUSDT = bar
                open_trade("TOMOUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_TOMOUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("TOMOUSDT end of long trade" in dt) and (status_trade_TOMOUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_TOMOUSDT:
                    close_trade("TOMOUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_TOMOUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "IOTAUSDT LONG" in dt and status_trade_IOTAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("IOTAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "IOTAUSDT SHORT" in dt and status_trade_IOTAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_IOTAUSDT = bar
                open_trade("IOTAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_IOTAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("IOTAUSDT end of long trade" in dt) and (status_trade_IOTAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_IOTAUSDT:
                    close_trade("IOTAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_IOTAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RVNUSDT LONG" in dt and status_trade_RVNUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RVNUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RVNUSDT SHORT" in dt and status_trade_RVNUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RVNUSDT = bar
                open_trade("RVNUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RVNUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RVNUSDT end of long trade" in dt) and (status_trade_RVNUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RVNUSDT:
                    close_trade("RVNUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RVNUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "UNIUSDT LONG" in dt and status_trade_UNIUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("UNIUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "UNIUSDT SHORT" in dt and status_trade_UNIUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_UNIUSDT = bar
                open_trade("UNIUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_UNIUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("UNIUSDT end of long trade" in dt) and (status_trade_UNIUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_UNIUSDT:
                    close_trade("UNIUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_UNIUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "IOTXUSDT LONG" in dt and status_trade_IOTXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("IOTXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "IOTXUSDT SHORT" in dt and status_trade_IOTXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_IOTXUSDT = bar
                open_trade("IOTXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_IOTXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("IOTXUSDT end of long trade" in dt) and (status_trade_IOTXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_IOTXUSDT:
                    close_trade("IOTXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_IOTXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ONEUSDT LONG" in dt and status_trade_ONEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ONEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ONEUSDT SHORT" in dt and status_trade_ONEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ONEUSDT = bar
                open_trade("ONEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ONEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ONEUSDT end of long trade" in dt) and (status_trade_ONEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ONEUSDT:
                    close_trade("ONEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ONEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RUNEUSDT LONG" in dt and status_trade_RUNEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RUNEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RUNEUSDT SHORT" in dt and status_trade_RUNEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RUNEUSDT = bar
                open_trade("RUNEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RUNEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RUNEUSDT end of long trade" in dt) and (status_trade_RUNEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RUNEUSDT:
                    close_trade("RUNEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RUNEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RLCUSDT LONG" in dt and status_trade_RLCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RLCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RLCUSDT SHORT" in dt and status_trade_RLCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RLCUSDT = bar
                open_trade("RLCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RLCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RLCUSDT end of long trade" in dt) and (status_trade_RLCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RLCUSDT:
                    close_trade("RLCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RLCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "EOSUSDT LONG" in dt and status_trade_EOSUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("EOSUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "EOSUSDT SHORT" in dt and status_trade_EOSUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_EOSUSDT = bar
                open_trade("EOSUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_EOSUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("EOSUSDT end of long trade" in dt) and (status_trade_EOSUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_EOSUSDT:
                    close_trade("EOSUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_EOSUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SUSHIUSDT LONG" in dt and status_trade_SUSHIUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SUSHIUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SUSHIUSDT SHORT" in dt and status_trade_SUSHIUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SUSHIUSDT = bar
                open_trade("SUSHIUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SUSHIUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SUSHIUSDT end of long trade" in dt) and (status_trade_SUSHIUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SUSHIUSDT:
                    close_trade("SUSHIUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SUSHIUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "WAVESUSDT LONG" in dt and status_trade_WAVESUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("WAVESUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "WAVESUSDT SHORT" in dt and status_trade_WAVESUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_WAVESUSDT = bar
                open_trade("WAVESUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_WAVESUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("WAVESUSDT end of long trade" in dt) and (status_trade_WAVESUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_WAVESUSDT:
                    close_trade("WAVESUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_WAVESUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "VETUSDT LONG" in dt and status_trade_VETUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("VETUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "VETUSDT SHORT" in dt and status_trade_VETUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_VETUSDT = bar
                open_trade("VETUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_VETUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("VETUSDT end of long trade" in dt) and (status_trade_VETUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_VETUSDT:
                    close_trade("VETUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_VETUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ZECUSDT LONG" in dt and status_trade_ZECUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ZECUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ZECUSDT SHORT" in dt and status_trade_ZECUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ZECUSDT = bar
                open_trade("ZECUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ZECUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ZECUSDT end of long trade" in dt) and (status_trade_ZECUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ZECUSDT:
                    close_trade("ZECUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ZECUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "XMRUSDT LONG" in dt and status_trade_XMRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("XMRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "XMRUSDT SHORT" in dt and status_trade_XMRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_XMRUSDT = bar
                open_trade("XMRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_XMRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("XMRUSDT end of long trade" in dt) and (status_trade_XMRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_XMRUSDT:
                    close_trade("XMRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_XMRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "MASKUSDT LONG" in dt and status_trade_MASKUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("MASKUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "MASKUSDT SHORT" in dt and status_trade_MASKUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_MASKUSDT = bar
                open_trade("MASKUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_MASKUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("MASKUSDT end of long trade" in dt) and (status_trade_MASKUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_MASKUSDT:
                    close_trade("MASKUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_MASKUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "STORJUSDT LONG" in dt and status_trade_STORJUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("STORJUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "STORJUSDT SHORT" in dt and status_trade_STORJUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_STORJUSDT = bar
                open_trade("STORJUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_STORJUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("STORJUSDT end of long trade" in dt) and (status_trade_STORJUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_STORJUSDT:
                    close_trade("STORJUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_STORJUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "XEMUSDT LONG" in dt and status_trade_XEMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("XEMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "XEMUSDT SHORT" in dt and status_trade_XEMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_XEMUSDT = bar
                open_trade("XEMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_XEMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("XEMUSDT end of long trade" in dt) and (status_trade_XEMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_XEMUSDT:
                    close_trade("XEMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_XEMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "KLAYUSDT LONG" in dt and status_trade_KLAYUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("KLAYUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "KLAYUSDT SHORT" in dt and status_trade_KLAYUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_KLAYUSDT = bar
                open_trade("KLAYUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_KLAYUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("KLAYUSDT end of long trade" in dt) and (status_trade_KLAYUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_KLAYUSDT:
                    close_trade("KLAYUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_KLAYUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DOGEUSDT LONG" in dt and status_trade_DOGEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DOGEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DOGEUSDT SHORT" in dt and status_trade_DOGEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DOGEUSDT = bar
                open_trade("DOGEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DOGEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DOGEUSDT end of long trade" in dt) and (status_trade_DOGEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DOGEUSDT:
                    close_trade("DOGEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DOGEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "AUDIOUSDT LONG" in dt and status_trade_AUDIOUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("AUDIOUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "AUDIOUSDT SHORT" in dt and status_trade_AUDIOUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_AUDIOUSDT = bar
                open_trade("AUDIOUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_AUDIOUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("AUDIOUSDT end of long trade" in dt) and (status_trade_AUDIOUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_AUDIOUSDT:
                    close_trade("AUDIOUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_AUDIOUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "1INCHUSDT LONG" in dt and status_trade_1INCHUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("1INCHUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "1INCHUSDT SHORT" in dt and status_trade_1INCHUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_1INCHUSDT = bar
                open_trade("1INCHUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_1INCHUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("1INCHUSDT end of long trade" in dt) and (status_trade_1INCHUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_1INCHUSDT:
                    close_trade("1INCHUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_1INCHUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "OGNUSDT LONG" in dt and status_trade_OGNUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("OGNUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "OGNUSDT SHORT" in dt and status_trade_OGNUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_OGNUSDT = bar
                open_trade("OGNUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_OGNUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("OGNUSDT end of long trade" in dt) and (status_trade_OGNUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_OGNUSDT:
                    close_trade("OGNUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_OGNUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "KSMUSDT LONG" in dt and status_trade_KSMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("KSMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "KSMUSDT SHORT" in dt and status_trade_KSMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_KSMUSDT = bar
                open_trade("KSMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_KSMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("KSMUSDT end of long trade" in dt) and (status_trade_KSMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_KSMUSDT:
                    close_trade("KSMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_KSMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "MTLUSDT LONG" in dt and status_trade_MTLUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("MTLUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "MTLUSDT SHORT" in dt and status_trade_MTLUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_MTLUSDT = bar
                open_trade("MTLUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_MTLUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("MTLUSDT end of long trade" in dt) and (status_trade_MTLUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_MTLUSDT:
                    close_trade("MTLUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_MTLUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BCHUSDT LONG" in dt and status_trade_BCHUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BCHUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BCHUSDT SHORT" in dt and status_trade_BCHUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BCHUSDT = bar
                open_trade("BCHUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BCHUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BCHUSDT end of long trade" in dt) and (status_trade_BCHUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BCHUSDT:
                    close_trade("BCHUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BCHUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ICPUSDT LONG" in dt and status_trade_ICPUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ICPUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ICPUSDT SHORT" in dt and status_trade_ICPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ICPUSDT = bar
                open_trade("ICPUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ICPUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ICPUSDT end of long trade" in dt) and (status_trade_ICPUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ICPUSDT:
                    close_trade("ICPUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ICPUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "TRBUSDT LONG" in dt and status_trade_TRBUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("TRBUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "TRBUSDT SHORT" in dt and status_trade_TRBUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_TRBUSDT = bar
                open_trade("TRBUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_TRBUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("TRBUSDT end of long trade" in dt) and (status_trade_TRBUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_TRBUSDT:
                    close_trade("TRBUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_TRBUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ETHUSDT LONG" in dt and status_trade_ETHUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ETHUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ETHUSDT SHORT" in dt and status_trade_ETHUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ETHUSDT = bar
                open_trade("ETHUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ETHUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ETHUSDT end of long trade" in dt) and (status_trade_ETHUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ETHUSDT:
                    close_trade("ETHUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ETHUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ETCUSDT LONG" in dt and status_trade_ETCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ETCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ETCUSDT SHORT" in dt and status_trade_ETCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ETCUSDT = bar
                open_trade("ETCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ETCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ETCUSDT end of long trade" in dt) and (status_trade_ETCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ETCUSDT:
                    close_trade("ETCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ETCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ATOMUSDT LONG" in dt and status_trade_ATOMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ATOMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ATOMUSDT SHORT" in dt and status_trade_ATOMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ATOMUSDT = bar
                open_trade("ATOMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ATOMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ATOMUSDT end of long trade" in dt) and (status_trade_ATOMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ATOMUSDT:
                    close_trade("ATOMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ATOMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ONTUSDT LONG" in dt and status_trade_ONTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ONTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ONTUSDT SHORT" in dt and status_trade_ONTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ONTUSDT = bar
                open_trade("ONTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ONTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ONTUSDT end of long trade" in dt) and (status_trade_ONTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ONTUSDT:
                    close_trade("ONTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ONTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BATUSDT LONG" in dt and status_trade_BATUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BATUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BATUSDT SHORT" in dt and status_trade_BATUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BATUSDT = bar
                open_trade("BATUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BATUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BATUSDT end of long trade" in dt) and (status_trade_BATUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BATUSDT:
                    close_trade("BATUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BATUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "NEOUSDT LONG" in dt and status_trade_NEOUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("NEOUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "NEOUSDT SHORT" in dt and status_trade_NEOUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_NEOUSDT = bar
                open_trade("NEOUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_NEOUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("NEOUSDT end of long trade" in dt) and (status_trade_NEOUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_NEOUSDT:
                    close_trade("NEOUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_NEOUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "IOSTUSDT LONG" in dt and status_trade_IOSTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("IOSTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "IOSTUSDT SHORT" in dt and status_trade_IOSTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_IOSTUSDT = bar
                open_trade("IOSTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_IOSTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("IOSTUSDT end of long trade" in dt) and (status_trade_IOSTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_IOSTUSDT:
                    close_trade("IOSTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_IOSTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "KNCUSDT LONG" in dt and status_trade_KNCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("KNCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "KNCUSDT SHORT" in dt and status_trade_KNCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_KNCUSDT = bar
                open_trade("KNCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_KNCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("KNCUSDT end of long trade" in dt) and (status_trade_KNCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_KNCUSDT:
                    close_trade("KNCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_KNCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SXPUSDT LONG" in dt and status_trade_SXPUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SXPUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SXPUSDT SHORT" in dt and status_trade_SXPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SXPUSDT = bar
                open_trade("SXPUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SXPUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SXPUSDT end of long trade" in dt) and (status_trade_SXPUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SXPUSDT:
                    close_trade("SXPUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SXPUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ZILUSDT LONG" in dt and status_trade_ZILUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ZILUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ZILUSDT SHORT" in dt and status_trade_ZILUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ZILUSDT = bar
                open_trade("ZILUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ZILUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ZILUSDT end of long trade" in dt) and (status_trade_ZILUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ZILUSDT:
                    close_trade("ZILUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ZILUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BANDUSDT LONG" in dt and status_trade_BANDUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BANDUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BANDUSDT SHORT" in dt and status_trade_BANDUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BANDUSDT = bar
                open_trade("BANDUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BANDUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BANDUSDT end of long trade" in dt) and (status_trade_BANDUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BANDUSDT:
                    close_trade("BANDUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BANDUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "MKRUSDT LONG" in dt and status_trade_MKRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("MKRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "MKRUSDT SHORT" in dt and status_trade_MKRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_MKRUSDT = bar
                open_trade("MKRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_MKRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("MKRUSDT end of long trade" in dt) and (status_trade_MKRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_MKRUSDT:
                    close_trade("MKRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_MKRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DEFIUSDT LONG" in dt and status_trade_DEFIUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DEFIUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DEFIUSDT SHORT" in dt and status_trade_DEFIUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DEFIUSDT = bar
                open_trade("DEFIUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DEFIUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DEFIUSDT end of long trade" in dt) and (status_trade_DEFIUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DEFIUSDT:
                    close_trade("DEFIUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DEFIUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BALUSDT LONG" in dt and status_trade_BALUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BALUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BALUSDT SHORT" in dt and status_trade_BALUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BALUSDT = bar
                open_trade("BALUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BALUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BALUSDT end of long trade" in dt) and (status_trade_BALUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BALUSDT:
                    close_trade("BALUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BALUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CRVUSDT LONG" in dt and status_trade_CRVUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CRVUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CRVUSDT SHORT" in dt and status_trade_CRVUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CRVUSDT = bar
                open_trade("CRVUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CRVUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CRVUSDT end of long trade" in dt) and (status_trade_CRVUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CRVUSDT:
                    close_trade("CRVUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CRVUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "EGLDUSDT LONG" in dt and status_trade_EGLDUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("EGLDUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "EGLDUSDT SHORT" in dt and status_trade_EGLDUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_EGLDUSDT = bar
                open_trade("EGLDUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_EGLDUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("EGLDUSDT end of long trade" in dt) and (status_trade_EGLDUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_EGLDUSDT:
                    close_trade("EGLDUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_EGLDUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ICXUSDT LONG" in dt and status_trade_ICXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ICXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ICXUSDT SHORT" in dt and status_trade_ICXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ICXUSDT = bar
                open_trade("ICXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ICXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ICXUSDT end of long trade" in dt) and (status_trade_ICXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ICXUSDT:
                    close_trade("ICXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ICXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "HNTUSDT LONG" in dt and status_trade_HNTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("HNTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "HNTUSDT SHORT" in dt and status_trade_HNTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_HNTUSDT = bar
                open_trade("HNTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_HNTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("HNTUSDT end of long trade" in dt) and (status_trade_HNTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_HNTUSDT:
                    close_trade("HNTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_HNTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "FLMUSDT LONG" in dt and status_trade_FLMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("FLMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "FLMUSDT SHORT" in dt and status_trade_FLMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_FLMUSDT = bar
                open_trade("FLMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_FLMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("FLMUSDT end of long trade" in dt) and (status_trade_FLMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_FLMUSDT:
                    close_trade("FLMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_FLMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "NEARUSDT LONG" in dt and status_trade_NEARUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("NEARUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "NEARUSDT SHORT" in dt and status_trade_NEARUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_NEARUSDT = bar
                open_trade("NEARUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_NEARUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("NEARUSDT end of long trade" in dt) and (status_trade_NEARUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_NEARUSDT:
                    close_trade("NEARUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_NEARUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RSRUSDT LONG" in dt and status_trade_RSRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RSRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RSRUSDT SHORT" in dt and status_trade_RSRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RSRUSDT = bar
                open_trade("RSRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RSRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RSRUSDT end of long trade" in dt) and (status_trade_RSRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RSRUSDT:
                    close_trade("RSRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RSRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "OCEANUSDT LONG" in dt and status_trade_OCEANUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("OCEANUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "OCEANUSDT SHORT" in dt and status_trade_OCEANUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_OCEANUSDT = bar
                open_trade("OCEANUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_OCEANUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("OCEANUSDT end of long trade" in dt) and (status_trade_OCEANUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_OCEANUSDT:
                    close_trade("OCEANUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_OCEANUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CVCUSDT LONG" in dt and status_trade_CVCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CVCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CVCUSDT SHORT" in dt and status_trade_CVCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CVCUSDT = bar
                open_trade("CVCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CVCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CVCUSDT end of long trade" in dt) and (status_trade_CVCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CVCUSDT:
                    close_trade("CVCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CVCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "AXSUSDT LONG" in dt and status_trade_AXSUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("AXSUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "AXSUSDT SHORT" in dt and status_trade_AXSUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_AXSUSDT = bar
                open_trade("AXSUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_AXSUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("AXSUSDT end of long trade" in dt) and (status_trade_AXSUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_AXSUSDT:
                    close_trade("AXSUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_AXSUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ALPHAUSDT LONG" in dt and status_trade_ALPHAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ALPHAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ALPHAUSDT SHORT" in dt and status_trade_ALPHAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ALPHAUSDT = bar
                open_trade("ALPHAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ALPHAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ALPHAUSDT end of long trade" in dt) and (status_trade_ALPHAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ALPHAUSDT:
                    close_trade("ALPHAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ALPHAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SKLUSDT LONG" in dt and status_trade_SKLUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SKLUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SKLUSDT SHORT" in dt and status_trade_SKLUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SKLUSDT = bar
                open_trade("SKLUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SKLUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SKLUSDT end of long trade" in dt) and (status_trade_SKLUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SKLUSDT:
                    close_trade("SKLUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SKLUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "GRTUSDT LONG" in dt and status_trade_GRTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("GRTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "GRTUSDT SHORT" in dt and status_trade_GRTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_GRTUSDT = bar
                open_trade("GRTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_GRTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("GRTUSDT end of long trade" in dt) and (status_trade_GRTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_GRTUSDT:
                    close_trade("GRTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_GRTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CHZUSDT LONG" in dt and status_trade_CHZUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CHZUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CHZUSDT SHORT" in dt and status_trade_CHZUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CHZUSDT = bar
                open_trade("CHZUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CHZUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CHZUSDT end of long trade" in dt) and (status_trade_CHZUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CHZUSDT:
                    close_trade("CHZUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CHZUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LITUSDT LONG" in dt and status_trade_LITUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LITUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LITUSDT SHORT" in dt and status_trade_LITUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LITUSDT = bar
                open_trade("LITUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LITUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LITUSDT end of long trade" in dt) and (status_trade_LITUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LITUSDT:
                    close_trade("LITUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LITUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "REEFUSDT LONG" in dt and status_trade_REEFUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("REEFUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "REEFUSDT SHORT" in dt and status_trade_REEFUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_REEFUSDT = bar
                open_trade("REEFUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_REEFUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("REEFUSDT end of long trade" in dt) and (status_trade_REEFUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_REEFUSDT:
                    close_trade("REEFUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_REEFUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ARPAUSDT LONG" in dt and status_trade_ARPAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ARPAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ARPAUSDT SHORT" in dt and status_trade_ARPAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ARPAUSDT = bar
                open_trade("ARPAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ARPAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ARPAUSDT end of long trade" in dt) and (status_trade_ARPAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ARPAUSDT:
                    close_trade("ARPAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ARPAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CELOUSDT LONG" in dt and status_trade_CELOUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CELOUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CELOUSDT SHORT" in dt and status_trade_CELOUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CELOUSDT = bar
                open_trade("CELOUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CELOUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CELOUSDT end of long trade" in dt) and (status_trade_CELOUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CELOUSDT:
                    close_trade("CELOUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CELOUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CELRUSDT LONG" in dt and status_trade_CELRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CELRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CELRUSDT SHORT" in dt and status_trade_CELRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CELRUSDT = bar
                open_trade("CELRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CELRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CELRUSDT end of long trade" in dt) and (status_trade_CELRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CELRUSDT:
                    close_trade("CELRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CELRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "GALAUSDT LONG" in dt and status_trade_GALAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("GALAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "GALAUSDT SHORT" in dt and status_trade_GALAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_GALAUSDT = bar
                open_trade("GALAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_GALAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("GALAUSDT end of long trade" in dt) and (status_trade_GALAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_GALAUSDT:
                    close_trade("GALAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_GALAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RAYUSDT LONG" in dt and status_trade_RAYUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RAYUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RAYUSDT SHORT" in dt and status_trade_RAYUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RAYUSDT = bar
                open_trade("RAYUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RAYUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RAYUSDT end of long trade" in dt) and (status_trade_RAYUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RAYUSDT:
                    close_trade("RAYUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RAYUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "TLMUSDT LONG" in dt and status_trade_TLMUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("TLMUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "TLMUSDT SHORT" in dt and status_trade_TLMUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_TLMUSDT = bar
                open_trade("TLMUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_TLMUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("TLMUSDT end of long trade" in dt) and (status_trade_TLMUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_TLMUSDT:
                    close_trade("TLMUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_TLMUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BTCUSDT LONG" in dt and status_trade_BTCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BTCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BTCUSDT SHORT" in dt and status_trade_BTCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BTCUSDT = bar
                open_trade("BTCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BTCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BTCUSDT end of long trade" in dt) and (status_trade_BTCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BTCUSDT:
                    close_trade("BTCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BTCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SANDUSDT LONG" in dt and status_trade_SANDUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("SANDUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SANDUSDT SHORT" in dt and status_trade_SANDUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SANDUSDT = bar
                open_trade("SANDUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SANDUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SANDUSDT end of long trade" in dt) and (status_trade_SANDUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SANDUSDT:
                    close_trade("SANDUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SANDUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "GTCUSDT LONG" in dt and status_trade_GTCUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("GTCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "GTCUSDT SHORT" in dt and status_trade_GTCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_GTCUSDT = bar
                open_trade("GTCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_GTCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("GTCUSDT end of long trade" in dt) and (status_trade_GTCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_GTCUSDT:
                    close_trade("GTCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_GTCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "STMXUSDT LONG" in dt and status_trade_STMXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("STMXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "STMXUSDT SHORT" in dt and status_trade_STMXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_STMXUSDT = bar
                open_trade("STMXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_STMXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("STMXUSDT end of long trade" in dt) and (status_trade_STMXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_STMXUSDT:
                    close_trade("STMXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_STMXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ZENUSDT LONG" in dt and status_trade_ZENUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ZENUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ZENUSDT SHORT" in dt and status_trade_ZENUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ZENUSDT = bar
                open_trade("ZENUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ZENUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ZENUSDT end of long trade" in dt) and (status_trade_ZENUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ZENUSDT:
                    close_trade("ZENUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ZENUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "HBARUSDT LONG" in dt and status_trade_HBARUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("HBARUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "HBARUSDT SHORT" in dt and status_trade_HBARUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_HBARUSDT = bar
                open_trade("HBARUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_HBARUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("HBARUSDT end of long trade" in dt) and (status_trade_HBARUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_HBARUSDT:
                    close_trade("HBARUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_HBARUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "MANAUSDT LONG" in dt and status_trade_MANAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("MANAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "MANAUSDT SHORT" in dt and status_trade_MANAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_MANAUSDT = bar
                open_trade("MANAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_MANAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("MANAUSDT end of long trade" in dt) and (status_trade_MANAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_MANAUSDT:
                    close_trade("MANAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_MANAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LINAUSDT LONG" in dt and status_trade_LINAUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LINAUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LINAUSDT SHORT" in dt and status_trade_LINAUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LINAUSDT = bar
                open_trade("LINAUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LINAUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LINAUSDT end of long trade" in dt) and (status_trade_LINAUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LINAUSDT:
                    close_trade("LINAUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LINAUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BAKEUSDT LONG" in dt and status_trade_BAKEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BAKEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BAKEUSDT SHORT" in dt and status_trade_BAKEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BAKEUSDT = bar
                open_trade("BAKEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BAKEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BAKEUSDT end of long trade" in dt) and (status_trade_BAKEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BAKEUSDT:
                    close_trade("BAKEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BAKEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "NKNUSDT LONG" in dt and status_trade_NKNUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("NKNUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "NKNUSDT SHORT" in dt and status_trade_NKNUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_NKNUSDT = bar
                open_trade("NKNUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_NKNUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("NKNUSDT end of long trade" in dt) and (status_trade_NKNUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_NKNUSDT:
                    close_trade("NKNUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_NKNUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "SCUSDT LONG" in dt and status_trade_SCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SCUSDT = bar
                open_trade("SCUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "SCUSDT SHORT" in dt and status_trade_SCUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_SCUSDT = bar
                open_trade("SCUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_SCUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("SCUSDT end of long trade" in dt) and (status_trade_SCUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_SCUSDT:
                    close_trade("SCUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_SCUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DENTUSDT LONG" in dt and status_trade_DENTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DENTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DENTUSDT SHORT" in dt and status_trade_DENTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DENTUSDT = bar
                open_trade("DENTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DENTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DENTUSDT end of long trade" in dt) and (status_trade_DENTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DENTUSDT:
                    close_trade("DENTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DENTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ANKRUSDT LONG" in dt and status_trade_ANKRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ANKRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ANKRUSDT SHORT" in dt and status_trade_ANKRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ANKRUSDT = bar
                open_trade("ANKRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ANKRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ANKRUSDT end of long trade" in dt) and (status_trade_ANKRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ANKRUSDT:
                    close_trade("ANKRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ANKRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "FLOWUSDT LONG" in dt and status_trade_FLOWUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("FLOWUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "FLOWUSDT SHORT" in dt and status_trade_FLOWUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_FLOWUSDT = bar
                open_trade("FLOWUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_FLOWUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("FLOWUSDT end of long trade" in dt) and (status_trade_FLOWUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_FLOWUSDT:
                    close_trade("FLOWUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_FLOWUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "PEOPLEUSDT LONG" in dt and status_trade_PEOPLEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("PEOPLEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "PEOPLEUSDT SHORT" in dt and status_trade_PEOPLEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_PEOPLEUSDT = bar
                open_trade("PEOPLEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_PEOPLEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("PEOPLEUSDT end of long trade" in dt) and (status_trade_PEOPLEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_PEOPLEUSDT:
                    close_trade("PEOPLEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_PEOPLEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BELUSDT LONG" in dt and status_trade_BELUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BELUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BELUSDT SHORT" in dt and status_trade_BELUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BELUSDT = bar
                open_trade("BELUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BELUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BELUSDT end of long trade" in dt) and (status_trade_BELUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BELUSDT:
                    close_trade("BELUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BELUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BNXUSDT LONG" in dt and status_trade_BNXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BNXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BNXUSDT SHORT" in dt and status_trade_BNXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BNXUSDT = bar
                open_trade("BNXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BNXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BNXUSDT end of long trade" in dt) and (status_trade_BNXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BNXUSDT:
                    close_trade("BNXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BNXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "BTCSTUSDT LONG" in dt and status_trade_BTCSTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("BTCSTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "BTCSTUSDT SHORT" in dt and status_trade_BTCSTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_BTCSTUSDT = bar
                open_trade("BTCSTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_BTCSTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("BTCSTUSDT end of long trade" in dt) and (status_trade_BTCSTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_BTCSTUSDT:
                    close_trade("BTCSTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_BTCSTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CHRUSDT LONG" in dt and status_trade_CHRUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CHRUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CHRUSDT SHORT" in dt and status_trade_CHRUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CHRUSDT = bar
                open_trade("CHRUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CHRUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CHRUSDT end of long trade" in dt) and (status_trade_CHRUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CHRUSDT:
                    close_trade("CHRUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CHRUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CTKUSDT LONG" in dt and status_trade_CTKUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CTKUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CTKUSDT SHORT" in dt and status_trade_CTKUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CTKUSDT = bar
                open_trade("CTKUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CTKUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CTKUSDT end of long trade" in dt) and (status_trade_CTKUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CTKUSDT:
                    close_trade("CTKUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CTKUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "CTSIUSDT LONG" in dt and status_trade_CTSIUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("CTSIUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "CTSIUSDT SHORT" in dt and status_trade_CTSIUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_CTSIUSDT = bar
                open_trade("CTSIUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_CTSIUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("CTSIUSDT end of long trade" in dt) and (status_trade_CTSIUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_CTSIUSDT:
                    close_trade("CTSIUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_CTSIUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DARUSDT LONG" in dt and status_trade_DARUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DARUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DARUSDT SHORT" in dt and status_trade_DARUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DARUSDT = bar
                open_trade("DARUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DARUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DARUSDT end of long trade" in dt) and (status_trade_DARUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DARUSDT:
                    close_trade("DARUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DARUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DGBUSDT LONG" in dt and status_trade_DGBUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DGBUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DGBUSDT SHORT" in dt and status_trade_DGBUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DGBUSDT = bar
                open_trade("DGBUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DGBUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DGBUSDT end of long trade" in dt) and (status_trade_DGBUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DGBUSDT:
                    close_trade("DGBUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DGBUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "DUSKUSDT LONG" in dt and status_trade_DUSKUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("DUSKUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "DUSKUSDT SHORT" in dt and status_trade_DUSKUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_DUSKUSDT = bar
                open_trade("DUSKUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_DUSKUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("DUSKUSDT end of long trade" in dt) and (status_trade_DUSKUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_DUSKUSDT:
                    close_trade("DUSKUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_DUSKUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ENJUSDT LONG" in dt and status_trade_ENJUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ENJUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ENJUSDT SHORT" in dt and status_trade_ENJUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ENJUSDT = bar
                open_trade("ENJUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ENJUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ENJUSDT end of long trade" in dt) and (status_trade_ENJUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ENJUSDT:
                    close_trade("ENJUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ENJUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ENSUSDT LONG" in dt and status_trade_ENSUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ENSUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ENSUSDT SHORT" in dt and status_trade_ENSUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ENSUSDT = bar
                open_trade("ENSUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ENSUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ENSUSDT end of long trade" in dt) and (status_trade_ENSUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ENSUSDT:
                    close_trade("ENSUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ENSUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "FTTUSDT LONG" in dt and status_trade_FTTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("FTTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "FTTUSDT SHORT" in dt and status_trade_FTTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_FTTUSDT = bar
                open_trade("FTTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_FTTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("FTTUSDT end of long trade" in dt) and (status_trade_FTTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_FTTUSDT:
                    close_trade("FTTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_FTTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "GMTUSDT LONG" in dt and status_trade_GMTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("GMTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "GMTUSDT SHORT" in dt and status_trade_GMTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_GMTUSDT = bar
                open_trade("GMTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_GMTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("GMTUSDT end of long trade" in dt) and (status_trade_GMTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_GMTUSDT:
                    close_trade("GMTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_GMTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "HOTUSDT LONG" in dt and status_trade_HOTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("HOTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "HOTUSDT SHORT" in dt and status_trade_HOTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_HOTUSDT = bar
                open_trade("HOTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_HOTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("HOTUSDT end of long trade" in dt) and (status_trade_HOTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_HOTUSDT:
                    close_trade("HOTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_HOTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "IMXUSDT LONG" in dt and status_trade_IMXUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("IMXUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "IMXUSDT SHORT" in dt and status_trade_IMXUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_IMXUSDT = bar
                open_trade("IMXUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_IMXUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("IMXUSDT end of long trade" in dt) and (status_trade_IMXUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_IMXUSDT:
                    close_trade("IMXUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_IMXUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "JASMYUSDT LONG" in dt and status_trade_JASMYUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("JASMYUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "JASMYUSDT SHORT" in dt and status_trade_JASMYUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_JASMYUSDT = bar
                open_trade("JASMYUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_JASMYUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("JASMYUSDT end of long trade" in dt) and (status_trade_JASMYUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_JASMYUSDT:
                    close_trade("JASMYUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_JASMYUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "LPTUSDT LONG" in dt and status_trade_LPTUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("LPTUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "LPTUSDT SHORT" in dt and status_trade_LPTUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_LPTUSDT = bar
                open_trade("LPTUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_LPTUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("LPTUSDT end of long trade" in dt) and (status_trade_LPTUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_LPTUSDT:
                    close_trade("LPTUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_LPTUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "OMGUSDT LONG" in dt and status_trade_OMGUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("OMGUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "OMGUSDT SHORT" in dt and status_trade_OMGUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_OMGUSDT = bar
                open_trade("OMGUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_OMGUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("OMGUSDT end of long trade" in dt) and (status_trade_OMGUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_OMGUSDT:
                    close_trade("OMGUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_OMGUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "OPUSDT LONG" in dt and status_trade_OPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_OPUSDT = bar
                open_trade("OPUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "OPUSDT SHORT" in dt and status_trade_OPUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_OPUSDT = bar
                open_trade("OPUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_OPUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("OPUSDT end of long trade" in dt) and (status_trade_OPUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_OPUSDT:
                    close_trade("OPUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_OPUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "RENUSDT LONG" in dt and status_trade_RENUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("RENUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "RENUSDT SHORT" in dt and status_trade_RENUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_RENUSDT = bar
                open_trade("RENUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_RENUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("RENUSDT end of long trade" in dt) and (status_trade_RENUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_RENUSDT:
                    close_trade("RENUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_RENUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "ROSEUSDT LONG" in dt and status_trade_ROSEUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("ROSEUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "ROSEUSDT SHORT" in dt and status_trade_ROSEUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_ROSEUSDT = bar
                open_trade("ROSEUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_ROSEUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("ROSEUSDT end of long trade" in dt) and (status_trade_ROSEUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_ROSEUSDT:
                    close_trade("ROSEUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_ROSEUSDT = 0
                    curr_num = curr_num - 1
            ...
            if "WOOUSDT LONG" in dt and status_trade_WOOUSDT == 0 and curr_num < max_trade:
                ...
                open_trade("WOOUSDT",  "LONG", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
            ...
            if "WOOUSDT SHORT" in dt and status_trade_WOOUSDT == 0 and curr_num < max_trade:
                ...
                bar = int(bar[1])
                last_bar_WOOUSDT = bar
                open_trade("WOOUSDT",  "SHORT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                status_trade_WOOUSDT = -1
                curr_num = curr_num + 1
            ...
            if ("WOOUSDT end of long trade" in dt) and (status_trade_WOOUSDT == 1) and curr_num > 0:
                ...
                if bar != last_bar_WOOUSDT:
                    close_trade("WOOUSDT", dt, "https://hook.eu1.make.com/wm64bn6jtb6veup8d8kpendu8rmrzv3y")
                    status_trade_WOOUSDT = 0
                    curr_num = curr_num - 1
